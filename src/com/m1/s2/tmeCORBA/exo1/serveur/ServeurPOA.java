...
/**
 * ServeurPOA.java . Generated by the IDL-to-Java compiler (portable), version
...
public abstract class ServeurPOA extends org.omg.PortableServer.Servant
	...
	public Serveur _this() {
		return ServeurHelper.narrow(super._this_object());
	}

	public Serveur _this(org.omg.CORBA.ORB orb) {
		return ServeurHelper.narrow(super._this_object(orb));
	}
